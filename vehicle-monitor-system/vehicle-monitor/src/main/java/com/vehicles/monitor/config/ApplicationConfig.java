...
public class ApplicationConfig {
    ...
    public VehicleStore vehicleStore() {
        ...
        System.out.println(">>>>>>>>>>vidToVehicles=======" + vidToVehicles.size());
        System.out.println(">>>>>>>>>>companyToVehicles===========" + companyToVehicles.size());
        System.out.println(">>>>>>>>>>vidToTime===========" + vidToTime.size());
